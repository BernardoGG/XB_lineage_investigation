...
**Table S1** contains the re-occurring deletions across the SARS-CoV-2 genome sequences used in this study, encoded as discrete traits, and is available in the [`Data`](Data/) directory.

**Table S2** presents a full list of the laboratories who produced the sequences used in this study and is available in the [`Acknowledgements`](Acknowledgements/) directory.
